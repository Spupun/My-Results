...
<div>
	...
	<div style="width:80%;float:left"><center><h1 style="margin-top:25px";><b>Centurion University of Technology and Management,BBSR</h1></center></div>
	<div style="width:10%;float:left"><img src="cutm.png" align="right" margin-top="1px" width="100" height="100"></div>
</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Sprong Boot</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Spring Boot Lab</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact CUTM,Bbsr.
Designed & Developed by @TeamMs</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @TeamMS</h5></center> 
  <hr class="new1">
<br>
</body>
</html>