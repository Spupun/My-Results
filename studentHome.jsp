...
<div>
	...
	<div style="width:80%;float:left"><center><h2 style="margin-top:25px";><b>Centurion University of Technology and Management,BBSR</h2></center></div>
	<div style="width:10%;float:left"><img src="cctm.png" align="right" margin-top="1px" width="100" height="100"></div>
</div>
    <a href="cutmOneView.html">Back</a>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Institution Name: Centurion University of Technology and Management,BBSR</th>
...
<body>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>CUTM151</td>
        <td colspan="2">Spring Boot Lab</td>
        <td>Practical</td>
        <td>30</td>
        <td>15</td>
...
Designed & Developed by Ms@Team</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @Ms@Team</h6></center> 
  <hr class="new1">
</body>
